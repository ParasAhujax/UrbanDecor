...
function cursorAnimation(){
    ...
    // const button = document.querySelector("#go-to-h a")
...
document.querySelector("#scroll").addEventListener("click",(e)=>{
    locoScroll.scrollTo(".category-heading",0,1000);
})
document.querySelector("#go-to-home").addEventListener("click",(details)=>{
